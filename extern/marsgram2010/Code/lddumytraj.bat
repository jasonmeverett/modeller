...
pause
gfortran  dumytraj_M10.F90 Cfiles_M10_C.o Ifiles_M10_I.o MARSSUBS_M10.o TESsubs_M10.o SETUP_M10.o wrapper_M10.o -o dumytraj_M10.exe
erase *.o
erase *.mod
copy dumytraj_M10.exe D:\MARS\Mars2010\Release1.0_Nov10\Executables
pause
erase dumytraj_M10.exe
pause
